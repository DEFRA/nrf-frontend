...
describe('Quote details page', () => {
  ...
  it('should render the page heading and title with the NRF reference', async () => {
    ...
    expect(document.title).toBe(
      `Your Nature restoration levy quote (${reference}) - Nature restoration levy - GOV.UK`
    )
  ...
  it('should show all summary rows for a full quote', async () => {
    ...
    expect(summaryList).toHaveTextContent('Other units')
    expect(summaryList).toHaveTextContent('Number of units units')
